...
При использовании облачного серивиса за хранение очереди придется платить - чем больше сообщений и дольше время хранения    
- тем больше затраты памяти и больше денежных затрат. При доставке сообщений получателю напрямую за ресурсы платить не придется.  
При возникновении всплеска сообщений со стороны издателя возможно замедление работы и перегрузка сети.  
Формат сообщений должен быть жестко регламентирован, для корректного разбиения на классы, и для корректной обработки потребителями.  
