...
Так же можно выполнить тонкую настройку OOM Killer - установаить параметр vm_overcommit_memory в значение 2. Такая настройка не даст системе сделать overcommit больше чем определенный процент от памяти, определенный в параметре overcommit_ratio. Если запрашиваем объем под overcommit не доступен - то система в нем отказывает.
